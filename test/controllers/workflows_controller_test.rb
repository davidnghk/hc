...
class WorkflowsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create workflow" do
    assert_difference('Workflow.count') do
      post workflows_url, params: { workflow: { Incident_type: @workflow.Incident_type, location_id: @workflow.location_id, manage_role_id: @workflow.manage_role_id } }
    end
  ...
  test "should update workflow" do
    patch workflow_url(@workflow), params: { workflow: { Incident_type: @workflow.Incident_type, location_id: @workflow.location_id, manage_role_id: @workflow.manage_role_id } }
